...
const SubcategoryList = () => {
    ...
    const handleProductSubmit = async (e) => {
        ...
        if (!selectedSubId) return toast.error("Please select a subcategory first");
        if (productImages.length === 0) return toast.error("At least one image is required");
        ...
        try {
            ...
            // Ensure stock and price are numbers before stringifying
            ...
            // Append variants as a stringified JSON array
                        ...
                        {!loading && filteredList.map((sub) => (
                            ...
                            >
                                <div className="col-span-5 flex items-center gap-8">
                                    <div 
                                        onClick={() => setActiveLightboxImage(getImageUrl(sub.image))}
                                        className="h-20 w-20 rounded-2xl bg-slate-50 dark:bg-white/5 flex items-center justify-center overflow-hidden border border-slate-200 dark:border-white/10 cursor-zoom-in group/img relative"
                                    >
                                        {sub.image ? (
                                            <>
                                                <img
